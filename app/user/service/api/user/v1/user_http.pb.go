...
func NewUserHandler(srv UserHandler, opts ...http1.HandleOption) http.Handler {
	...
	r.HandleFunc("/api.user.v1.User/DeleteUser", func(w http.ResponseWriter, r *http.Request) {
...
func (c *UserHTTPClientImpl) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...http1.CallOption) (out *DeleteUserReply, err error) {
	path := binding.EncodePath("POST", "/api.user.v1.User/DeleteUser", in)
	out = &DeleteUserReply{}

	err = c.cc.Invoke(ctx, path, nil, &out, http1.Method("POST"), http1.PathPattern("/api.user.v1.User/DeleteUser"))
...
func (c *UserHTTPClientImpl) ListUser(ctx context.Context, in *ListUserRequest, opts ...http1.CallOption) (out *ListUserReply, err error) {
	path := binding.EncodePath("POST", "/api.user.v1.User/ListUser", in)
	out = &ListUserReply{}

	err = c.cc.Invoke(ctx, path, nil, &out, http1.Method("POST"), http1.PathPattern("/api.user.v1.User/ListUser"))
...
func (c *UserHTTPClientImpl) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...http1.CallOption) (out *UpdateUserReply, err error) {
	path := binding.EncodePath("POST", "/api.user.v1.User/UpdateUser", in)
	out = &UpdateUserReply{}

	err = c.cc.Invoke(ctx, path, nil, &out, http1.Method("POST"), http1.PathPattern("/api.user.v1.User/UpdateUser"))
